  ...
  <div class="color-picker">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2">
        <div class="card">
          <ImageUpload v-if="!imageLoaded" @image-loaded="handleImageLoaded" />
      ...
      <div class="color-info-section">
        <ColorInfo v-if="selectedColor" :color="selectedColor" class="mb-6" />
...
<script>
import ImageUpload from "@/views/tools/ColorPicker/ImageUpload.vue";
import MagnifyingGlass from "@/views/tools/ColorPicker//MagnifyingGlass.vue";
import ColorInfo from "@/views/tools/ColorPicker//ColorInfo.vue";
import ColorPalette from "@/views/tools/ColorPicker//ColorPalette.vue";
import {
  extractImageColors,
  rgbToHex,
  rgbToHsl,
