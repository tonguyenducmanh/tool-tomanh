...
declare function request(options: { method: string; url: string; headers?: Record<string, string>; body?: string | null }): Promise<{ status: number; headers: Record<string, string>; body: any }>;
...
declare function requestMulti(requests: Array<{ method: string; url: string; headers?: Record<string, string>; body?: string | null }>): Promise<Array<{ status: number; headers: Record<string, string>; body: any }>>;
