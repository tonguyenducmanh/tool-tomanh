export default {
  i18nCommon: {
    popup: {
      ...
      resizeN: "Kéo chỉnh cạnh trên",
      resizeS: "Kéo chỉnh cạnh dưới",
      resizeE: "Kéo chỉnh cạnh phải",
      resizeW: "Kéo chỉnh cạnh trái",
      resizeNE: "Kéo chỉnh góc trên phải",
      resizeNW: "Kéo chỉnh góc trên trái",
      resizeSE: "Kéo chỉnh góc dưới phải",
      resizeSW: "Kéo chỉnh góc dưới trái",
    },
    tabManager: {
    ...
    record: "Bản ghi",
    copy: "Sao chép",
    copyCell: "Sao chép nội dung ô",
    copyRow: "Sao chép nội dung dòng",
    copyTable: "Sao chép nội dung toàn bộ bảng",
    ...
    tdheader: {
      ...
      backgroundEffectTooltip: "Click để chọn hiệu ứng nền",
      cursorEffectTooltip: "Click để chọn hiệu ứng chuột",
      themes: "Chủ đề ứng dụng",
      backgroundEffects: "Hiệu ứng nền",
      cursorEffects: "Hiệu ứng chuột",
    },
    ...
    wrapText: "Xuống dòng",
    changeMonacoTheme: "Đổi màu Editor",
    agreement:
    ...
    excelToJSON: {
      uploadLabel: "Chọn file Excel",
      outputLabel: "Kết quả JSON",
      outputPlaceholder: "JSON sẽ xuất hiện ở đây...",
      downloadJSON: "Tải file JSON",
      allSheets: "Tất cả các sheet",
    ...
    apiTesting: {
      changeToViewBody: "Body",
      changeToViewHeader: "Header",
      changeToViewHeaderResponse: "Header",
      changeToViewBodyResponse: "Body",
      clickToViewHeader: "Nhấn để xem header",
      clickToViewBody: "Nhấn để xem body",
      clickToViewHeaderResponse: "Nhấn để xem response header",
      clickToViewBodyResponse: "Nhấn để xem response body",
      statusCodeTooltip: "Nhấn để đổi status code",
      ...
      responseHeadersPlaceholder: "Response Header",
      send: "Gửi",
      clear: "Xóa tất cả",
    ...
    postgreSQLQuery: {
      ...
      loadIntellisense: "Load gợi ý mới từ server",
      loadCachedIntellisense: "Load gợi ý từ cache",
      connectionName: "Tên kết nối",
      ...
      cloneIntellisenseSearch: "Lọc kết nối...",
      cloneIntellisense: "Load gợi ý đã lưu của database khác",
      cloneIntellisenseTitle: "Chọn database nguồn",
      cloneIntellisenseTooltip: "Nhấn để sao chép gợi ý sang database hiện tại",
      cloneIntellisenseEmpty: "Không có kết nối nào khác",
      ...
      databaseOps: {
        backupToSql: "Sao lưu",
        backupSchemaOnly: "Sao lưu cấu trúc",
        restoreFromSql: "Phục hồi",
        cloneDatabase: "Nhân bản",
        cloneSchemaOnly: "Nhân bản cấu trúc",
        menuBackupDatabase: "Sao lưu database",
        menuRestoreDatabase: "Phục hồi database",
        menuCloneDatabase: "Nhân bản database",
        sourceConnection: "Kết nối nguồn",
        targetConnection: "Kết nối đích",
        dumpFile: "File Dump SQL",
        dropOrClick: "Thả file .sql vào đây hoặc nhấn để chọn",
        noDumpFile: "Vui lòng chọn file dump SQL trước",
        processing: "Đang xử lý...",
        backupSuccess: "Sao lưu thành công",
        restoreSuccess: "Phục hồi thành công",
        cloneSuccess: "Nhân bản thành công",
        pgBinPath: "Đường dẫn PostgreSQL bin",
      },
    },
  },
};
