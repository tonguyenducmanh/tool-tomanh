export default {
  i18nCommon: {
    popup: {
      ...
      close: "Close",
      drag: "Drag to move",
      resizeN: "Resize top edge",
      resizeS: "Resize bottom edge",
      resizeE: "Resize right edge",
      resizeW: "Resize left edge",
      resizeNE: "Resize top-right corner",
      resizeNW: "Resize top-left corner",
      resizeSE: "Resize bottom-right corner",
      resizeSW: "Resize bottom-left corner",
    },
    tabManager: {
    ...
    record: "Records",
    copy: "Copy",
    copyCell: "Copy cell content",
    copyRow: "Copy row content",
    copyTable: "Copy entire table content",
    ...
    excelToJSON: {
      uploadLabel: "Choose Excel file",
      outputLabel: "JSON Result",
    ...
    toastMessage: {
      ...
      notFoundAgentServer:
        "Failed to connect, click Help and download the agent",
      cannotCopy:
    ...
    apiTesting: {
      ...
      clickToViewHeader: "Click to view header",
      clickToViewBody: "Click to view body",
      clickToViewHeaderResponse: "Click to view response header",
      clickToViewBodyResponse: "Click to view response body",
      statusCodeTooltip: "Set response status code",
    ...
    APIMocking: {
      ...
      restartedMock: "Restarted mock server",
      refresh: "Refresh",
    ...
    postgreSQLQuery: {
      ...
      formatCode: "Format code",
      loadIntellisense: "Load fresh intellisense from server",
      loadCachedIntellisense: "Load intellisense from cache",
      connectionName: "Connection name",
      ...
      intellisenseLoaded: "Intellisense loaded successfully",
      intellisenseLoading: "Loading intellisense...",
      ...
      deleteGroupErr: "Error deleting group",
      createConnectionSuccess: "Connection created successfully",
      createConnectionErr: "Error creating connection",
      updateConnectionSuccess: "Connection updated successfully",
      updateConnectionErr: "Error updating connection",
      deleteConnectionSuccess: "Connection deleted successfully",
      deleteConnectionErr: "Error deleting connection",
      saveQuerySuccess: "Query saved successfully",
      ...
      dbInspect: {
        ...
        searchErrorFallback: "Search error",
        ddlError: "Could not get DDL",
        ddlErrorFallback: "Error getting DDL",
        table: "Table",
        view: "View",
        function: "Function",
        trigger: "Trigger",
      ...
      databaseOps: {
        backupToSql: "Backup",
        backupSchemaOnly: "Backup Structure",
        restoreFromSql: "Restore",
        cloneDatabase: "Clone",
        cloneSchemaOnly: "Clone Structure",
        menuBackupDatabase: "Backup database",
        menuRestoreDatabase: "Restore database",
        menuCloneDatabase: "Clone database",
        sourceConnection: "Source Connection",
        targetConnection: "Target Connection",
        dumpFile: "SQL Dump File",
        dropOrClick: "Drop .sql file here or click to browse",
        noDumpFile: "Please select a SQL dump file first",
        processing: "Processing...",
        backupSuccess: "Backup completed successfully",
        restoreSuccess: "Restore completed successfully",
        cloneSuccess: "Clone completed successfully",
